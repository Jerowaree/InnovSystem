...
export async function exportWorkspaceReport(input: {
  ...
  try {
    ...
    summarySheet.addRows([
      ...
      {
        field: "Periodo",
        value: getEffectivePeriodLabel(input.selectedPeriod),
      },
      ...
      {
        field: "Movimientos incluidos",
        value: String(selectedMovements.length),
      },
    ...
    detailSheet.getRow(input.type === "balance" ? 2 : 1).font = {
      bold: true,
    };
